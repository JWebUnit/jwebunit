/*
 * Jacobie http://sourceforge.net/projects/jacobie/ is a Java 
 * based API for use with Internet Explorer. Based on the 
 * JACOB project and the IE COM Object, it directly controls 
 * IE from java. This API can be used as a true end-user web browser 
 * test with IE and not a Http-Based test such as HttpUnit.
 * 
