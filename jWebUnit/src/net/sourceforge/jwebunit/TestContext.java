 ...
 * {@link net.sourceforge.jwebunit.WebTestCase} or {@link net.sourceforge.jwebunit.WebTester}.
 *
...
public class TestContext {
    ...
    /**
     * Set authentication information for the test context.  This information
     * is used by {@link HttpUnitDialog} to set authorization on the WebConversation
     * when the dialog is begun.
     *
    ...
    /**
     * Add a cookie to the test context.  These cookies are set on the WebConversation
     * when an {@link HttpUnitDialog} is begun.
     *
    ...
    /**
     * Return the locale established for the test context.  If the locale
     * has not been explicitly set, Locale.getDefault() will be returned.
     */
    ...
    /**
     * Return the encoding scheme for the test context.  The default
     * encoding scheme is ISO-8859-1.
     */
    ...
    /**
     * Set the encoding scheme for the test context which is applied
     * to response text.
     */
    ...
    /**
     * Set a resource bundle to use for the test context (will be used to lookup
     * expected values by key in WebTester).
     *
    ...
    /**
     * Return the base URL for the test context.  The default base URL is
