...
public class SeleniumDialog implements IJWebUnitDialog {
	...
	/* (non-Javadoc)
	 * @see com.capgemini.capwebunit.IJWebUnitDialog#clickLinkWithImage(java.lang.String, int)
	 */
	...
	/* (non-Javadoc)
	 * @see com.capgemini.capwebunit.IJWebUnitDialog#isLinkPresentWithImage(java.lang.String, int)
	 */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.jwebunit.IJWebUnitDialog#checkCheckbox(java.lang.String, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.jwebunit.IJWebUnitDialog#clickLinkWithExactText(java.lang.String, int)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.jwebunit.IJWebUnitDialog#clickLinkWithTextAfterText(java.lang.String, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.jwebunit.IJWebUnitDialog#isLinkPresentWithExactText(java.lang.String, int)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.jwebunit.IJWebUnitDialog#setFormParameter(java.lang.String, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.jwebunit.IJWebUnitDialog#uncheckCheckbox(java.lang.String, java.lang.String)
     */
