...
public interface IJWebUnitDialog {
	 ...
	 *             If there are still unconsummed alert since a previous call of
	 *             this method.
	 */
	 ...
	 *             If there are still unconsummed confirm since a previous call
	 *             of this method.
	 */
	 ...
	 * @param inputs What we should put in the prompt
	 * @param actions Whether we should click on "OK" (true) or "Cancel" (false)
	 * @throws ExpectedJavascriptPromptException If there are still unconsummed prompt since a previous call
	 *             of this method.
	 */
	void setExpectedJavaScriptPrompt(JavascriptPrompt[] prompts) throws ExpectedJavascriptPromptException;
