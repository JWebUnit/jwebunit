...
public class JWebUnitTester {
     ...
     * @deprecated You should not use specific dialog fonctionality (will become
     *             protected).
     */
     ...
     */
    public void assertTitleMatch(String regexp) throws RESyntaxException, AssertMatchException {
        RE re = null;
     ...
     */
    public void assertTitleEqualsKey(String titleKey) throws AssertEqualsException {
        if (!getMessage(titleKey).equals(getDialog().getPageTitle())) {
            throw new AssertEqualsException(getMessage(titleKey), getDialog().getPageTitle());
        }
    }
     ...
     * @param text
     */
    public void assertTextNotPresent(String text) throws AssertContainsException {
        if (getDialog().getPageText().indexOf(text) >= 0)
            throw new AssertContainsException(text, getDialog().getPageText());
    }
