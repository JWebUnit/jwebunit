...
/**
 * This name reflects the name all of exceptions that will be thrown from a specific "testing engine" or soon deprecated
 * name of "dialog".
 * 
 * All testing engines will respond, if necessary, using this exception instead of the testing specific engine
 * exceptions.
 * 
 * Example: HttpUnit is SAX based and depending on specific operations from httpunit a SAXException is thrown, but the
 * HttpUnitDialog method will catch the original exception and wrap inside this TestingEngineResponseException
 * 
